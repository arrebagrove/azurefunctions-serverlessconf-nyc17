...
# Configure Function
1. In the portal, expand the function and click Integrate in the the expanded view.
...
3. For the click setting, add a Internet Request function to the button by searching in the function menu.
